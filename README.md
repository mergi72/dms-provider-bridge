...
[![Bridge Version](https://img.shields.io/badge/Bridge-v0.4.21-blue)](https://github.com/mergi72/dms-provider-bridge/releases/tag/v0.4.21)
[![Bridge Setup](https://img.shields.io/badge/Setup-v0.4.21-blueviolet)](https://github.com/mergi72/dms-provider-bridge/releases/tag/v0.4.21)
...
- Bridge repository latest changelog version: `0.4.21`
- Latest bridge-only release: `v0.4.21`
...
- Service mode:
  ...
  - Current `v0.4.21` installer installs this service as `LocalSystem`.
  - `LocalSystem` cannot see credentials stored in an interactive user's Windows Credential Manager.

Current setup release `v0.4.21` is the Service mode installer. TC user mode remains a separate runtime model for scenarios where user-scoped credentials are required.
