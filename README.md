...
- Bridge repository latest changelog version: `0.8.1-beta`
- Latest bridge-only release: `v0.8.1-beta`
...
Current setup release `v0.8.1-beta` is the Service mode installer with bootstrapper-based user AppData handling. TC user mode remains a separate runtime model for scenarios where user-scoped credentials are required.
