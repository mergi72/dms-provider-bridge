...
- Bridge repository latest changelog version: `1.1.0`
- Latest bridge-only release: `v1.1.0`
...
Current setup release `v1.1.0` is the Service mode installer with bootstrapper-based user AppData handling. TC user mode remains a separate runtime model for scenarios where user-scoped credentials are required.
