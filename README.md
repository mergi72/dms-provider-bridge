...
[![Bridge Version](https://img.shields.io/badge/Bridge-v0.4.2-blue)](https://github.com/mergi72/dms-provider-bridge/releases/tag/v0.4.2)
[![Bridge Setup](https://img.shields.io/badge/Setup-v0.4.2-blueviolet)](https://github.com/mergi72/dms-provider-bridge/releases/tag/v0.4.2)
...
- Bridge repository latest changelog version: `0.4.2`
- Latest bridge-only release: `v0.4.2`
...
- Service mode:
  ...
  - Current `v0.4.2` installer installs this service as `LocalSystem`.
  - `LocalSystem` cannot see credentials stored in an interactive user's Windows Credential Manager.

Current setup release `v0.4.2` is the Service mode installer. TC user mode remains a separate runtime model for scenarios where user-scoped credentials are required.
