...
[![Bridge Version](https://img.shields.io/badge/Bridge-v0.7.1--beta-blue)](https://github.com/mergi72/dms-provider-bridge/releases/tag/v0.7.1-beta)
...
- Bridge repository latest changelog version: `0.7.1-beta`
- Latest bridge-only release: `v0.7.1-beta`
