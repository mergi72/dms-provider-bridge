...
OutputBaseFilename=DmsProviderBridgeSetup-v0.8.7-beta
Compression=lzma
SolidCompression=yes
WizardStyle=modern

[Files]
Source: "artifacts\installer\DmsProviderBridgeSetupCore-v0.8.7-beta.exe"; DestDir: "{tmp}"; Flags: ignoreversion deleteafterinstall
...
begin
  if CurStep = ssPostInstall then begin
    CoreSetupPath := ExpandConstant('{tmp}\DmsProviderBridgeSetupCore-v0.8.7-beta.exe');
